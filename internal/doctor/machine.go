...
type Graphics struct {
	...
	Socket string
	// Outputs is what niri answers that it has, and NiriErr is why it did not
	// answer. Names only: what is on a screen is nobody's business but the
...
// askNiri asks the compositor what outputs it has.
//
